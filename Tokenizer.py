...
if __name__ == "__main__":
    ...
    with open(name_file, encoding='utf-8') as f:
        for line in f:
            words = regexp_tokenize(line, pattern=r'\w+|\$[\d\.]+|\S+')
            token_words = {}
    ...
    for word in token_words:
        token_file.write(word + "\twas split to:\t'" + token_words[word][0] + "',\t'" + token_words[word][1] + "',\t'" + token_words[word][2] + "'\n" )
