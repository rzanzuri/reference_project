...
if __name__ == "__main__":
    ...
    run_in_parallel_go_command(1900,200)
    run_in_parallel_go_command(2100,200)
    run_in_parallel_go_command(2300,200)
    run_in_parallel_go_command(2500,200)
    run_in_parallel_go_command(2700,200)
    run_in_parallel_go_command(2900,120)
